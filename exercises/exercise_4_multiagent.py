...
def check_routing(state: State) -> list[Send]:
    ...
    if any(kw in question_lower for kw in ["data", "privacy", "gdpr", "dữ liệu", "du lieu"]):
...
Tập trung: GDPR, data protection, privacy rights, data breach, consent,
nghĩa vụ thông báo vi phạm dữ liệu và rủi ro phạt hành chính."""
